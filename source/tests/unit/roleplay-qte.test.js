...
test('Role selection bypass and auto-start', () => {
  const content = fs.readFileSync(path.resolve(__dirname, '../../src/surfaces/group-3-8104/features/lessons/reader/ReadingTheatre.jsx'), 'utf-8');
...
test('QTE language display requirements', () => {
  const content = fs.readFileSync(path.resolve(__dirname, '../../src/surfaces/group-3-8104/features/lessons/challenges/Challenges.jsx'), 'utf-8');
